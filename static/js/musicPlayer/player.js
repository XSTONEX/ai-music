(function ($) {
	...
	for (var i = 0; i < playlist.length; i++) {
		var item = playlist[i];
		$('#playlist').append('<li class="lib" style="overflow:hidden;"><strong style="margin-left: 5px;">' + item.title + '</strong><span style="float: left;" class="artist">' + item.artist + '</span></li>');
		if (item.mp3 == "") {
