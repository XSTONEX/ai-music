var _STRINGS = {
    ...
    _UI = {
        winresult: {
            ...
            meta: {
                image: "vikingmedia/graphics/game/ui/win-result-atlas.png",
                size: {
                    w: 434,
                    h: 409
                },
    ...
    _CARD = {
        ...
        meta: {
            image: "vikingmedia/graphics/game/card.png",
            imageBig: "vikingmedia/graphics/game/card-big.png",
            imagebw: "vikingmedia/graphics/game/cardbw.png",
            size: {
                w: 273,
                h: 326
            },
    ...
    _TROOPS_CARD = {
        ...
        meta: {
            image: "vikingmedia/graphics/game/troops-card.png",
            size: {
                w: 324,
                h: 307
            },
...
ig.module("plugins.audio.sound-info").defines(function() {
    SoundInfo = ig.Class.extend({
        ...
        sfx: {
            kittyopeningSound: {
                path: "vikingmedia/audio/opening/kittyopening"
            },
            staticSound: {
                path: "vikingmedia/audio/play/static"
            },
            openingSound: {
                path: "vikingmedia/audio/opening/opening"
            },
            battleSound: {
                path: "vikingmedia/audio/game/start-battle-long"
            },
            clickSound: {
                path: "vikingmedia/audio/game/click"
            },
            starOneSound: {
                path: "vikingmedia/audio/game/sone"
            },
            starTwoSound: {
                path: "vikingmedia/audio/game/stwo"
            },
            starThreeSound: {
                path: "vikingmedia/audio/game/sthree"
            },
            woshArrowSound: {
                path: "vikingmedia/audio/game/arrow-shower-f"
            },
            woshFireSound: {
                path: "vikingmedia/audio/game/wosh-fireball-a"
            },
            berserkSound: {
                path: "vikingmedia/audio/game/berserk"
            },
            fireblastSound: {
                path: "vikingmedia/audio/game/explode"
            },
            freezSound: {
                path: "vikingmedia/audio/game/freez"
            },
            hammerEarthSound: {
                path: "vikingmedia/audio/game/earthquake-fade"
            },
            hammercrushSound: {
                path: "vikingmedia/audio/game/giant-sound"
            },
            thunderSound: {
                path: "vikingmedia/audio/game/thunder"
            },
            maleOneSound: {
                path: "vikingmedia/audio/game/m-aikh"
            },
            maleTwoSound: {
                path: "vikingmedia/audio/game/m-argh"
            },
            maleThreeSound: {
                path: "vikingmedia/audio/game/m-ok"
            },
            maleFourSound: {
                path: "vikingmedia/audio/game/m-yach"
            },
            femaleSound: {
                path: "vikingmedia/audio/game/mage"
            },
            hitMeleSound: {
                path: "vikingmedia/audio/game/meleweapon"
            }
        },
        bgm: {
            background: {
                path: "vikingmedia/audio/bgm",
                startOgg: 0,
                endOgg: 12.309,
                startMp3: 0,
                endMp3: 12.309
...
ig.module("plugins.splash-loader").requires("impact.loader", "impact.animation").defines(function() {
    ig.SplashLoader = ig.Loader.extend({
        splashDesktop: new ig.Image("vikingmedia/graphics/splash/mobile/cover.jpg"),
        splashMobile: new ig.Image("vikingmedia/graphics/splash/mobile/cover.jpg"),
        loadingImg: new ig.Image("vikingmedia/graphics/game/loading-bar.png"),
        init: function(b, c) {
            this.parent(b, c);
...
ig.module("plugins.branding.splash").requires("impact.impact", "impact.entity").defines(function() {
    ...
    EntityBranding = ig.Entity.extend({
        ...
        splash: new ig.Image("vikingbranding/splash1.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
        ...
        checkClickableLayer: function(b, c, d) {
            "undefined" == typeof wm && (this.doesClickableLayerExist(b) ? (ig.game.showOverlay([b]), $("#" + b).find("[href]").attr("href", c)) : this.createClickableOutboundLayer(b, c, "vikingmedia/graphics/misc/invisible.png", d))
        },
...
ig.module("plugins.clickable-div-layer").requires("plugins.data.vector").defines(function() {
    ClickableDivLayer = ig.Class.extend({
        ...
        identifier: null,
        invisImagePath: "vikingmedia/graphics/misc/invisible.png",
        init: function(b) {
...
ig.module("game.entities.buttons.button-branding-logo").requires("game.entities.buttons.button", "plugins.clickable-div-layer").defines(function() {
    EntityButtonBrandingLogo = EntityButton.extend({
        type: ig.Entity.TYPE.A,
        gravityFactor: 0,
        logo: new ig.AnimationSheet("vikingbranding/logo.png", _SETTINGS.Branding.Logo.Width, _SETTINGS.Branding.Logo.Height),
        zIndex: 10001,
        size: {
            x: 64,
            y: 66
...
ig.module("game.entities.buttons.button-more-games").requires("game.entities.buttons.button", "plugins.clickable-div-layer").defines(function() {
    EntityButtonMoreGames = EntityButton.extend({
        type: ig.Entity.TYPE.A,
        gravityFactor: 0,
        logo: new ig.AnimationSheet("vikingmedia/graphics/game/more_games_btn.png", 71, 40),
        size: {
            x: 71,
            y: 40
        },
...
ig.module("game.entities.opening-shield").requires("impact.entity").defines(function() {
    EntityOpeningShield = ig.Entity.extend({
        ...
        shieldAnim: 0,
        titleAnim: 0,
        shieldImage: new ig.Image("vikingmedia/graphics/opening/shield.png"),
        mIconImage: new ig.Image("vikingmedia/graphics/opening/m_icon.png"),
        titleImage: new ig.Image("vikingmedia/graphics/opening/title.png"),
        init: function(b, c, d) {
            this.parent(b, c, d)
        },
        ready: function() {
...
ig.module("game.entities.opening-kitty").requires("impact.entity").defines(function() {
    EntityOpeningKitty = ig.Entity.extend({
        ...
        kittyAnim: -1,
        kittyImage: new ig.Image("vikingmedia/graphics/opening/kitty.png"),
        kittyTitleImage: new ig.Image("vikingmedia/graphics/opening/kittytitle.png"),
...
ig.module("game.entities.troopers.battle-trainer").requires("impact.entity").defines(function() {
    EntityBattleTrainer = ig.Entity.extend({
        walkSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/mage-w.png", 30, 50),
        walkRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/mage-wr.png", 30, 50),
        attackSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/mage-a.png", 35, 50),
        attackRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/mage-ar.png", 35, 50),
        offset: {
            x: 28,
            y: 25
        },
...
ig.module("game.entities.tutorial-game").requires("impact.entity").defines(function() {
    EntityTutorialGame = ig.Entity.extend({
        zIndex: 1800,
        tutBBchat: new ig.Image("vikingmedia/graphics/game/tutorial-chat-player.png"),
        tutTowerD: new ig.Image("vikingmedia/graphics/game/tutorial-tower-d.png"),
        bubbleChatPos: {
            x: -120,
            y: 70
        },
    ...
    EntityHand = ig.Entity.extend({
        handUp: new ig.Image("vikingmedia/graphics/game/hand_up.png"),
        handClick: new ig.Image("vikingmedia/graphics/game/hand_click.png"),
        isClick: !1,
        zIndex: 1500,
        init: function(b, c, d) {
            this.parent(b, c, d)
...
ig.module("game.entities.main-background").requires("impact.entity", "game.entities.tutorial-game").defines(function() {
    EntityMainBackground = ig.Entity.extend({
        zIndex: 1,
        bgImage: new ig.Image("vikingmedia/graphics/splash/mobile/cover.jpg"),
        init: function(b, c, d) {
            this.parent(b, c, d)
        },
        ready: function() {
...
ig.module("game.entities.buttons.button-battle").requires("game.entities.buttons.button").defines(function() {
    EntityButtonBattle = EntityButton.extend({
        ...
        fillColor: null,
        zIndex: 151,
        img: new ig.Image("vikingmedia/graphics/game/ui/empty-btn.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.buttons.button-deck").requires("game.entities.buttons.button").defines(function() {
    EntityButtonDeck = EntityButton.extend({
        ...
        fillColor: null,
        zIndex: 1E3,
        img: new ig.Image("vikingmedia/graphics/game/ui/deck-btn.png"),
        init: function(b, c, d) {
            this.parent(b, c, d)
        },
        clicked: function() {
...
ig.module("game.entities.buttons.button-sound").requires("game.entities.buttons.button").defines(function() {
    EntityButtonSound = EntityButton.extend({
        ...
        fillColor: null,
        zIndex: 95E3,
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/ui/sound-btn.png", 29, 23),
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.buttons.button-yes").requires("game.entities.buttons.button").defines(function() {
    EntityButtonYes = EntityButton.extend({
        ...
        img: new ig.Image("vikingmedia/graphics/game/ui/small-empty-btn.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.ui.popup-tutorial").requires("impact.entity", "game.entities.buttons.button-yes", "game.entities.buttons.button-no").defines(function() {
    EntityPopupTutorial = ig.Entity.extend({
        img: new ig.Image("vikingmedia/graphics/game/tutorial-popup.png"),
        zIndex: 200,
        size: {
            x: 316,
            y: 255
...
ig.module("game.entities.deck-background").requires("impact.entity").defines(function() {
    EntityDeckBackground = ig.Entity.extend({
        zIndex: 1,
        img: new ig.Image("vikingmedia/graphics/game/deck-bg.png"),
        init: function(b, c, d) {
            this.parent(b, c, d)
        },
        ready: function() {
...
ig.module("game.entities.buttons.button-use").requires("game.entities.buttons.button").defines(function() {
    EntityButtonUse = EntityButton.extend({
        ...
        zIndex: 120,
        img: new ig.Image("vikingmedia/graphics/game/ui/xs-empty-btn.png", 129, 62),
        callBy: null,
        battleDeck: null,
        init: function(b, c, d) {
            this.parent(b, c, d)
...
ig.module("game.entities.buttons.button-info").requires("game.entities.buttons.button").defines(function() {
    EntityButtonInfo = EntityButton.extend({
        ...
        size: new Vector2(85, 41),
        zIndex: 120,
        img: new ig.Image("vikingmedia/graphics/game/ui/xs-empty-btn.png"),
        callBy: null,
        battleDeck: null,
        init: function(b, c, d) {
            this.parent(b, c, d)
...
ig.module("game.entities.buttons.button-close").requires("game.entities.buttons.button").defines(function() {
    EntityButtonClose = EntityButton.extend({
        ...
        followPos: null,
        oneShot: !1,
        img: new ig.Image("vikingmedia/graphics/game/ui/close-btn.png"),
        init: function(b, c, d) {
            this.parent(b, c, d)
        },
        update: function() {
...
ig.module("game.entities.ui.popup-info").requires("impact.entity", "game.entities.buttons.button-use", "game.entities.buttons.button-close").defines(function() {
    EntityPopupInfo = ig.Entity.extend({
        img: new ig.Image("vikingmedia/graphics/game/ui/popup-info.png"),
        infoBoxImg: new ig.Image("vikingmedia/graphics/game/ui/info-box.png"),
        hpIconImg: new ig.Image("vikingmedia/graphics/game/ui/heart-icon.png"),
        dmgIconImg: new ig.Image("vikingmedia/graphics/game/ui/dmg-icon.png"),
        dpsIconImg: new ig.Image("vikingmedia/graphics/game/ui/dps-icon.png"),
        durationIconImg: new ig.Image("vikingmedia/graphics/game/ui/duration-spell.png"),
        durspellIconImg: new ig.Image("vikingmedia/graphics/game/ui/duration.png"),
        moveIconImg: new ig.Image("vikingmedia/graphics/game/ui/move-icon.png"),
        typeBoxImg: new ig.Image("vikingmedia/graphics/game/ui/type-info.png"),
        zIndex: 2E3,
        size: {
            x: 427,
            y: 454
...
ig.module("game.entities.ui.battle-deck").requires("impact.entity", "game.entities.card-show", "game.entities.buttons.button-use", "game.entities.buttons.button-info", "game.entities.ui.popup-info").defines(function() {
    EntityBattleDeck = ig.Entity.extend({
        zIndex: 101,
        deckImg: new ig.Image("vikingmedia/graphics/game/ui/battle-deck.png"),
        readPos: {
            x: 0,
            y: 0
        },
...
ig.module("game.entities.game-background").requires("impact.entity").defines(function() {
    EntityGameBackground = ig.Entity.extend({
        zIndex: 1,
        bgImage: new ig.Image("vikingmedia/graphics/game/game-bg.png"),
        init: function(b, c, d) {
            this.parent(b, c, d)
        },
        ready: function() {
...
ig.module("game.entities.tower").requires("impact.entity").defines(function() {
    EntityTower = ig.Entity.extend({
        ...
        freezActive: !1,
        stunActive: !1,
        bgHPbar: new ig.Image("vikingmedia/graphics/game/bg-hp-bar.png"),
        blueHPbar: new ig.Image("vikingmedia/graphics/game/blue-bar-e.png"),
        redHPbar: new ig.Image("vikingmedia/graphics/game/red-bar-e.png"),
        cekLogic: null,
        checkScoreOneShot: !1,
        swingsound: "",
        init: function(b, c, d) {
...
ig.module("game.entities.bullets.bullet-arrow").requires("game.entities.bullets.base-bullets").defines(function() {
    EntityBulletArrow = EntityBaseBullets.extend({
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/bullet-rest.png", 12, 26),
        size: {
            x: 5,
            y: 5
        },
...
ig.module("game.entities.tower-ruins").requires("impact.entity").defines(function() {
    EntityTowerRuins = ig.Entity.extend({
        img: new ig.Image("vikingmedia/graphics/game/tower-ruins.png"),
        offset: {
            x: 7,
            y: 0
        },
    ...
    EntityBigTowerRuins = ig.Entity.extend({
        img: new ig.Image("vikingmedia/graphics/game/towerb-ruins.png"),
        offset: {
            x: 7,
            y: 0
        },
...
ig.module("game.entities.tower-small").requires("game.entities.tower", "game.entities.bullets.bullet-arrow", "game.entities.tower-ruins").defines(function() {
    EntityTowerSmall = EntityTower.extend({
        ...
        towerImg: new ig.Image("vikingmedia/graphics/game/tower.png"),
        balistaImg: new ig.Image("vikingmedia/graphics/game/balista.png"),
        colorStyle: "##ff00a7",
...
ig.module("game.entities.tower-big").requires("game.entities.tower", "game.entities.bullets.bullet-tower", "game.entities.tower-ruins").defines(function() {
    EntityTowerBig = EntityTower.extend({
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/red-anim-tower.png", 109, 98),
        otherAnim: new ig.AnimationSheet("vikingmedia/graphics/game/blue-anim-tower.png", 109, 102),
        size: {
            x: 46,
            y: 62
        },
...
ig.module("game.entities.effects.explode").requires("game.entities.effects.splash-area").defines(function() {
    EntityExplode = EntitySplashArea.extend({
        zIndex: 1800,
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/effects/explode.png", 45, 45),
        offset: {
            x: 5,
            y: 5
        },
    ...
    EntityBigExplode = EntitySplashArea.extend({
        zIndex: 1800,
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/effects/big-explode.png", 110, 110),
        offset: {
            x: 22,
            y: 12
        },
    ...
    EntityTExplode = ig.Entity.extend({
        zIndex: 1800,
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/effects/t-explode.png", 70, 70),
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.effects.fireball").requires("impact.entity").defines(function() {
    EntityFireball = ig.Entity.extend({
        zIndex: 1800,
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/effects/fireball.png", 50, 90),
        size: {
            x: 20,
            y: 25
        },
...
ig.module("game.entities.effects.lightning").requires("game.entities.effects.splash-area").defines(function() {
    EntityLightning = EntitySplashArea.extend({
        ...
        segments: 10,
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/effects/smoke-s.png", 84, 55),
        stunTiming: 0.1,
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.effects.arrow-shower").requires("impact.entity", "game.entities.effects.splash-area").defines(function() {
    EntityArrowShower = EntitySplashArea.extend({
        ...
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/effects/arrow-shower-s.png", 115, 115),
        init: function(b, c, d) {
            this.parent(b, c, d);
    ...
    EntityRainArrow = ig.Entity.extend({
        zIndex: 1800,
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/effects/arrow-rain-s.png", 90, 108),
        ang: 0,
        offset: {
            x: 45,
            y: 54
...
ig.module("game.entities.effects.freez").requires("game.entities.effects.splash-area").defines(function() {
    EntityFreez = EntitySplashArea.extend({
        zIndex: 10,
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/effects/freez.png", 116, 96),
        size: {
            x: 90,
            y: 78
        },
...
ig.module("game.entities.effects.hammer-crush").requires("game.entities.effects.splash-area").defines(function() {
    EntityHammerCrush = EntitySplashArea.extend({
        zIndex: 10,
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/effects/hammer-crush-s.png", 80, 80),
        size: {
            x: 75,
            y: 75
        },
...
ig.module("game.entities.effects.berserk").requires("game.entities.effects.splash-area").defines(function() {
    EntityBerserk = EntitySplashArea.extend({
        ...
        berserkIMG: new ig.Image("vikingmedia/graphics/game/effects/berserk-s.png"),
        timeDuration: 4,
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.pos.x = b - this.size.x / 2;
...
ig.module("game.entities.bullets.bullet-axe").requires("game.entities.bullets.base-bullets").defines(function() {
    EntityBulletAxe = EntityBaseBullets.extend({
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/bullet-axe.png", 20, 20),
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.bullets.bullet-bomb").requires("game.entities.bullets.base-bullets").defines(function() {
    EntityBulletBomb = EntityBaseBullets.extend({
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/bullet-bomb.png", 20, 20),
        speedMovement: 125,
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.ui.board-deck").requires("impact.entity").defines(function() {
    EntityBoardDeck = ig.Entity.extend({
        zIndex: 101,
        deckImg: new ig.Image("vikingmedia/graphics/game/ui/board-deck.png"),
        nextCard: [],
...
ig.module("game.entities.ui.mana-bar").requires("impact.entity").defines(function() {
    EntityManaBar = ig.Entity.extend({
        zIndex: 102,
        manabarImg: new ig.Image("vikingmedia/graphics/game/ui/mana-bar.png"),
        manaImg: new ig.Image("vikingmedia/graphics/game/ui/mana.png"),
        mana: 3,
        timeStamp: 0,
        manaRegen: 2.5,
        manaPosx: 3.5,
...
ig.module("game.entities.effects.splash-elixer").requires("impact.entity", "impact.entity-pool").defines(function() {
    EntitySplashElixer = ig.Entity.extend({
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/splash-elixer.png", 30, 35),
        init: function(b, c, d) {
            this.parent(b, c, d);
    ...
    EntityElixerDrop = ig.Entity.extend({
        img: new ig.Image("vikingmedia/graphics/game/elixer.png"),
        cekDelta: 0,
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.troopers.archer").requires("game.entities.troopers.base-troops", "game.entities.bullets.bullet-arrow").defines(function() {
    EntityArcher = EntityBaseTroops.extend({
        attackSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/archer-a.png", 40, 50),
        attackRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/archer-ar.png", 40, 50),
        walkSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/archer-w.png", 40, 50),
        walkRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/archer-wr.png",
            40, 50),
        offset: {
            x: 12,
            y: 25
...
ig.module("game.entities.troopers.bomb").requires("game.entities.troopers.base-troops").defines(function() {
    EntityBomb = EntityBaseTroops.extend({
        attackSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/bomb-a.png", 35, 35),
        walkSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/bomb-w.png", 35, 40),
        attackRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/bomb-ar.png", 35, 35),
        walkRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/bomb-wr.png", 35, 40),
        testingMovement: !1,
        offset: {
            x: 10,
            y: 20
...
ig.module("game.entities.troopers.axeman").requires("game.entities.troopers.base-troops").defines(function() {
    EntityAxeman = EntityBaseTroops.extend({
        attackSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/xmen-a.png", 55, 50),
        walkSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/xmen-w.png", 50, 50),
        attackRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/xmen-ar.png", 55, 50),
        walkRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/xmen-wr.png", 50, 50),
        testingMovement: !1,
        offset: {
            x: 14,
            y: 20
...
ig.module("game.entities.troopers.axethrow").requires("game.entities.troopers.base-troops").defines(function() {
    EntityAxethrow = EntityBaseTroops.extend({
        attackSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/xthrow-a.png", 50, 50),
        walkSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/xthrow-w.png", 60, 50),
        attackRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/xthrow-ar.png", 50, 50),
        walkRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/xthrow-wr.png", 60, 50),
        testingMovement: !1,
        offset: {
            x: 10,
            y: 20
...
ig.module("game.entities.troopers.giant").requires("game.entities.troopers.base-troops").defines(function() {
    EntityGiant = EntityBaseTroops.extend({
        attackSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/giant-a.png", 90, 80),
        walkSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/giant-w.png", 75, 80),
        attackRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/giant-ar.png", 90, 80),
        walkRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/giant-wr.png", 75, 80),
        testingMovement: !1,
        offset: {
            x: 28,
            y: 25
...
ig.module("game.entities.troopers.hammer").requires("game.entities.troopers.base-troops").defines(function() {
    EntityHammer = EntityBaseTroops.extend({
        attackSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/hammer-a.png", 60, 65),
        walkSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/hammer-w.png", 65, 60),
        attackRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/hammer-ar.png", 60, 65),
        walkRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/hammer-wr.png", 65, 60),
        testingMovement: !1,
        offset: {
            x: 8,
            y: 34
...
ig.module("game.entities.troopers.warrior").requires("game.entities.troopers.base-troops").defines(function() {
    EntityWarrior = EntityBaseTroops.extend({
        attackSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/warrior-attack-b.png", 55, 65),
        walkSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/walk-warrior-b.png", 55, 65),
        attackRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/warrior-attack-r.png", 55, 65),
        walkRSheet: new ig.AnimationSheet("vikingmedia/graphics/game/troops/walk-warrior-r.png", 55,
            65),
        testingMovement: !1,
        offset: {
            x: 17,
...
ig.module("game.entities.ui.score").requires("impact.entity").defines(function() {
    EntityScore = ig.Entity.extend({
        zIndex: 102,
        redScore: new ig.Image("vikingmedia/graphics/game/ui/red-score.png"),
        blueScore: new ig.Image("vikingmedia/graphics/game/ui/blue-score.png"),
        intScoreBlue: 0,
        intScoreRed: 0,
        init: function(b, c, d) {
            this.parent(b, c, d)
...
ig.module("game.entities.ui.time-game").requires("impact.entity", "game.entities.ui.info-text").defines(function() {
    EntityTimeGame = ig.Entity.extend({
        bgTime: new ig.Image("vikingmedia/graphics/game/ui/timer.png"),
        zIndex: 1799,
        seconds: 0,
        minutes: 2,
        elapse: 180.5,
...
ig.module("game.entities.effects.spark").requires("impact.entity", "impact.entity-pool").defines(function() {
    EntitySpark = ig.Entity.extend({
        testImage: new ig.Image("vikingmedia/graphics/game/spark.png"),
        maxVel: {
            x: 100,
            y: 100
        },
...
ig.module("game.entities.buttons.button-pause").requires("game.entities.buttons.button", "game.entities.ui.popup-pause").defines(function() {
    EntityButtonPause = EntityButton.extend({
        ...
        zIndex: 95E3,
        animSheet: new ig.AnimationSheet("vikingmedia/graphics/game/ui/timer.png", 64, 38),
        img: new ig.Image("vikingmedia/graphics/game/ui/pause-icon.png"),
        imgPos: {
            x: 30,
            y: 10
        },
...
ig.module("game.levels.test-desktop").requires("impact.image", "game.entities.branding-logo-placeholder", "game.entities.buttons.button-more-games", "game.entities.pointer").defines(function() {
    LevelTestDesktop = {
        ...
        layer: [{
            ...
            linkWithCollision: !1,
            visible: 1,
            tilesetName: "vikingmedia/graphics/backgrounds/desktop/background.jpg",
            repeat: !1,
            preRender: !0,
            distance: "1",
            tilesize: 16,
    ...
    LevelTestDesktopResources = [new ig.Image("vikingmedia/graphics/backgrounds/desktop/background.jpg")]
});
ig.baked = !0;
ig.module("game.levels.test-mobile").requires("impact.image", "game.entities.branding-logo-placeholder", "game.entities.buttons.button-more-games", "game.entities.pointer").defines(function() {
    LevelTestMobile = {
        ...
        layer: [{
            ...
            linkWithCollision: !1,
            visible: 1,
            tilesetName: "vikingmedia/graphics/backgrounds/mobile/background.jpg",
            repeat: !1,
            preRender: !0,
            distance: "1",
            tilesize: 16,
    ...
    LevelTestMobileResources = [new ig.Image("vikingmedia/graphics/backgrounds/mobile/background.jpg")]
});
ig.baked = !0;
